  ...
  <tr>
    <td align="center">
      <a href="https://github.com/HenryModesto" title="Github Henry">
        <img src="API-Flask/Pictures/HENRYZ.jfif" width="150px;" heigth="200px;" alt="Foto de Henry Oliveira Modesto De Jesus"/><br>
        <sub>
          <b>HENRY MODESTO</b>
          <b>2401244</b>
        </sub>
    ...
    <td align="center">
      <a href="https://github.com/GabryelVenancio" title="Github Gabryel Venancio">
        <img src="API-Flask/Pictures/Cleffs.jpeg" width="150px;" alt="Foto de Gabryel Venancio Cleffs do Nascimento"/><br>
        <sub>
    ...
    <td align="center">
      <a href="https://github.com/AndreyT1224" title="Github Andrey">
        <img src="API-Flask/Pictures/ANDREW.jpeg" width="150px;" alt="Foto de Andrey Tomaz Silva Alves "/><br>
        <sub>
          <b>ANDREY TOMAZ</b>
          <b>2400729</b>
        </sub>
