  ...
  <tr>
    <td align="center" style="padding: 10px;">
      <a href="https://github.com/HenryModesto" title="Github Henry" style="text-decoration: none; color: black;">
        <img src="API-Flask/Pictures/HENRYZ.jfif" width="200px" height="200px" alt="Foto de Henry Oliveira Modesto De Jesus" style="border-radius: 8px;"/><br>
        <sub>
    ...
    <td align="center" style="padding: 10px;">
      <a href="https://github.com/GabryelVenancio" title="Github Gabryel Venancio" style="text-decoration: none; color: black;">
        <img src="API-Flask/Pictures/Cleffs.jpeg" width="200px" alt="Foto de Gabryel Venancio Cleffs do Nascimento" style="border-radius: 8px;"/><br>
        <sub>
    ...
    <td align="center" style="padding: 10px;">
      <a href="https://github.com/AndreyT1224" title="Github Andrey" style="text-decoration: none; color: black;">
        <img src="API-Flask/Pictures/ANDREW.jpeg" width="190px" alt="Foto de Andrey Tomaz Silva Alves" style="border-radius: 8px;"/><br>
        <sub>
          <b>ANDREY TOMAZ</b><br>
          <b>2400729</b>
        </sub>
